export const site = {
  ...
  social: {
    facebook: "https://www.facebook.com/epsigconsultores",
    instagram: "https://www.instagram.com/epsigconsultores",
  },
  badges: [
    "Partner Odoo",
...
export const kitConsultingServices = [
  ...
  {
    slug: "360-transformacion-digital",
...
export const kitDigitalCategories = [
  ...
  {
    slug: "ciberseguridad-gestionada",
